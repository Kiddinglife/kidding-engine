...
inline extern  ACE_CDR::Boolean operator>> ( ACE_InputCDR &is, std::string& value )
{
	TRACE("string >>");
	value.clear();
	static char c;
...
inline extern  ACE_CDR::Boolean operator<< ( ACE_OutputCDR &os, std::string& str )
{
	TRACE("string <<");
...
inline extern  ACE_CDR::Boolean operator<< ( ACE_OutputCDR &os, const ACE_CDR::Char* x )
{
	TRACE("char* <<");
...
inline extern  ACE_CDR::Boolean operator>> ( ACE_InputCDR &in,
	ACE_CDR::Octet& value )
{
...
inline extern  ACE_CDR::Boolean operator<< ( ACE_OutputCDR &os,
	ACE_CDR::Octet value )
{
	TRACE("ACE_CDR::Octet value  <<");
