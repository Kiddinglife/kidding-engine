...
#define MACHINE_MESSAGE_HANDLER_ARGS2(NAME, ARG_TYPE1, ARG_NAME1, ARG_TYPE2, ARG_NAME2)\
	...
	{\
       ...
       ACE_DEBUG((LM_DEBUG, "%M::#NAME##MachineMessagehandler1::INT1(%d)", ARG_NAME1)); \
		...
		ARG_NAME2 = p->osbuff_->rd_ptr(); \
       ACE_DEBUG((LM_DEBUG, "%M::#NAME##MachineMessagehandler1::INT1(%s)", ARG_NAME2)); \
        }\
	};
#else
#define MACHINE_MESSAGE_HANDLER_ARGS2(NAME, ARG_TYPE1, ARG_NAME1,ARG_TYPE2, ARG_NAME2)
...
TEST_MSG_DECL_ARGS2(SRV, msg1, NETWORK_FIXED_MESSAGE, ACE_UINT64, INT1, char*, INT2)
