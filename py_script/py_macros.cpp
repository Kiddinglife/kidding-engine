...
PyMODINIT_FUNC initnoddy(void)
{
	...
	// All the other type methods are NULL, so we will go over them later ¡ª thats for a later section!
...
// ¡ª you should be able to import noddy and play around with Noddy objects.
